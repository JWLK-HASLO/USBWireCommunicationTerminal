package co.haslo.USBWireCommunicationTerminal.usbDeviceManager;

import co.haslo.USBWireCommunicationTerminal.util.Dlog;

import static co.haslo.USBWireCommunicationTerminal.util.ConvertData.hexStringArrayToInt32bit8HexArray;
import static co.haslo.USBWireCommunicationTerminal.util.ConvertData.hexStringToShort16bit4HexArray;
